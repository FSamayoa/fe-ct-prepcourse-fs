...
function invocarMetodo(objeto, metodo) {
   ...
   // Tu código:
   //var nombreFuncion = objeto[metodo];
...
function tieneEmail(objetoUsuario) {
   ...
   // Tu código:
   var valida = objetoUsuario.hasOwnProperty("email");
   if (valida === true && objetoUsuario.email !== null){
      return true;
   } else {
      return false;
   }
...
function tienePropiedad(objeto, propiedad) {
   ...
   // En ese caso retornar true. Caso contrario, false.
   // Tu código:
   var valida = objeto.hasOwnProperty(propiedad);
   if (valida === true){
      return true;
   } else {
      return false;
